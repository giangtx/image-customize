...
class Handler implements HandlerOptions {
	...
	public canvasOption?: any = defaults.canvasOption;
	...
	public importJSON = async (json: any, callback?: (canvas: FabricCanvas) => void) => {
		...
		let prevLeft = 0;
		let prevTop = 0;
		this.canvas.setBackgroundColor((this.canvasOption as any).backgroundColor, this.canvas.renderAll.bind(this.canvas));
	 ...
	 */
	public setCanvasOption = (canvasOption: any) => {
