		...
		return (
			...
			>
				<Flex style={{ marginLeft: 8 }} flex="0 1 auto">
					...
					<Tooltip title={i18next.t('action.go-github') as any} overlayStyle={{ fontSize: 16 }}>
						<Button
					...
					<Tooltip title={i18next.t('action.go-docs') as any} overlayStyle={{ fontSize: 16 }}>
						<Button
							className="rde-action-btn"
							style={{
								color: 'white',
					...
					<Tooltip title={i18next.t('action.shortcut-help') as any} overlayStyle={{ fontSize: 16 }}>
						<Button
							className="rde-action-btn"
							style={{
								color: 'white',
				...
				<Flex style={{ marginLeft: 88 }}>
					...
					>
						<Menu.Item key="imagemap" style={{ color: '#fff' }}>
							{i18next.t('imagemap.imagemap') as any}
						</Menu.Item>
						<Menu.Item key="workflow" style={{ color: '#fff' }}>
							{i18next.t('workflow.workflow') as any}
						</Menu.Item>
